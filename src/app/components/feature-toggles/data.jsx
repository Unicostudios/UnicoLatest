  ...
  return (
    <div className="h-full w-full p-4">
      ...
      <div className="-ml-1.5 mb-4 flex items-center gap-1.5">
        ...
        />
        <div>
          <span className="block text-sm font-montserrat-medium">Andrea Smith</span>
          <span className="block text-xs text-zinc-600">Site Reliability</span>
        </div>
      </div>
      <div className="mb-1 line-clamp-1 text-xl font-montserrat-medium">
...
const OverlayTask = () => {
  return (
    <div className="absolute left-1/2 top-1/2 z-10 w-64 -translate-x-1/2 -translate-y-1/2 rotate-3 rounded-lg border-2 border-indigo-600 bg-white p-4 shadow-xl shadow-indigo-600/20">
      ...
      <span className="mb-0.5 block text-lg font-montserrat-medium">
        Launch landing page
      </span>
  ...
  return (
    <div className="relative h-full min-w-96 p-4 pb-0 pt-0">
      ...
      <div className="absolute bottom-0 left-1/3 top-0 w-0.5 bg-indigo-600">
        <span className="absolute left-0 top-0 -translate-x-1/2 rounded-b bg-indigo-500 px-1.5 pb-0.5 text-xs font-montserrat-medium text-white">
          Now
        </span>
      </div>
    </div>
...
const DocumentationComponent = () => {
  return (
    <div className="relative p-4">
      ...
      <div className="mb-4 flex items-center gap-1.5">
        <span className="block w-fit rounded-full bg-blue-100 px-2 py-1 text-xs font-montserrat-medium text-blue-900">
          John Smith
        </span>
        <span className="block w-fit rounded-full bg-green-100 px-2 py-1 text-xs font-montserrat-medium text-green-900">
          Beth Davis
        </span>
      </div>
      <span className="relative mb-1.5 inline-block text-lg font-montserrat-medium">
