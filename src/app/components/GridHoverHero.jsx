    ...
    <div className="bg-neutral-950">
      ...
      <motion.div className="font-montserrat-regular pointer-events-none absolute inset-0 flex flex-col items-center justify-center p-8 z-0 mt-5">
        ...
        {click && (
          <button
            onClick={click}
            className="pointer-events-auto rounded-full bg-[#5F14E0] px-10 py-2 text-xs xs:text-sm md:text-base text-white mix-blend-difference font-montserrat-medium cursor-pointer"
          >
            {btn}
          </button>
        )}
